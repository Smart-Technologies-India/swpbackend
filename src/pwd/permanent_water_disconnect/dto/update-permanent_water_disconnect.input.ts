...
import { CreatePermanentWaterDisconnectInput } from './create-permanent_water_disconnect.input';
...
@InputType()
export class UpdatePermanentWaterDisconnectInput extends PartialType(
